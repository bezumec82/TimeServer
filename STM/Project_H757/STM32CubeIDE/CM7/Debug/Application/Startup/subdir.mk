...
Application/Startup/startup_stm32h757xihx.o: ../Application/Startup/startup_stm32h757xihx.s
	arm-none-eabi-gcc -mcpu=cortex-m7 -g3 -c -x assembler-with-cpp -MMD -MP -MF"Application/Startup/startup_stm32h757xihx.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
