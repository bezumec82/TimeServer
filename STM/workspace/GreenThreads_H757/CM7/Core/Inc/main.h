...
#define USB_FS1_VBUS_Pin GPIO_PIN_9
#define USB_FS1_VBUS_GPIO_Port GPIOA
...
#define eINK_BUSY_Pin GPIO_PIN_7
#define eINK_BUSY_GPIO_Port GPIOG
...
#define eINC_DAT_CMD_Pin GPIO_PIN_2
#define eINC_DAT_CMD_GPIO_Port GPIOK
